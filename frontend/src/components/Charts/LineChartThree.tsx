...
const baseOptions: ApexOptions = {
  ...
  title: {
    // text: 'The chart title', // ! The chart title is missing
...
const LineChartThree: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const shouldFetchChartData = selectedBodega.length && selectedSku.length;

    if (shouldFetchChartData) {
      fetchChartData();
    }
  }, [selectedSku]); // Fetch data when filters change
